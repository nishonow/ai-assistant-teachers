...
class GeminiHelper:
    ...
    async def generate_answer(self, question: str, language: str = "ru") -> str:
        ...
        prompt = (
            ...
            "If information is uncertain, clearly say so and suggest contacting a licensed lawyer. "
            "Prefer structured answers: short conclusion, key points, and practical steps. "
            "Keep the answer concise by default (3-6 short bullet points or up to ~120 words). "
            "Expand only when user asks for details or when the case is high-risk/complex. "
            "Avoid long introductions and avoid repeating disclaimers in every answer. "
